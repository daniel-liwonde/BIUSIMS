...
//$subj_id=$rowsub['subject_id'];
                            ...
                            <strong><li class="icon-user icon-large"></li>&nbsp;Modify Past Results</strong></div>
                            
                            
                            
                            
                            <div class="control-group">
                                                <label class="control-label" for="inputPassword"> Please Selest Details Below</label>
                                                <div class="controls">
           <form action="" method="get">
                                            ...
                                            <?php
                                            $query = mysqli_query($conn,"select * from subject and category='1' order by subject_title ASC ");
...
<button class="btn btn-success" id="doSave<?php echo $id ?>" onclick='$.getJSON("do2_masters.php",{
