...
$subj_id=$rowsub['subject_id'];
                            ...
                            <strong><i class="icon-group icon-large"></i>&nbsp;&nbsp;<span style="text-decoration:blink; color:green"><a onclick='$("#msg").html("Ready for grade entry now"),$.getJSON("x.php");'> <?php echo $rowsub['subject_title'];?></a></span>&nbsp;(<?php if(checksem()==1 )echo "Jan-June &nbsp;". date('Y')." &nbsp;&nbsp;Sem )";else echo "July-Dec &nbsp;". date('Y')." &nbsp;Sem )";  if((isset($sem3))||(isset($s1))|| (isset($s2)) || (isset($d))){ $a1=$s1-$d;$a2=$s2-$d;$a3=$sem3-$d; if($a1<1 )$a1=0;if($a2<1)$a2=0; if($a3<1)$a3=0;echo "&nbsp;&nbsp;Remaining days for grades entry Deadline&nbsp;&nbsp;<font color='red'>"; if($sem3==0) echo " ";else echo"EXAM:</font>". $a3."days&nbsp;";if($s1==0) echo " ";else echo"<font color='red'>ASSIGN#1:</font>".$a1."day(s)&nbsp;"; if($s2==0) echo " ";else echo"<font color='red'>ASSIGN#2:</font>".$a2."day(s)";}?></strong><div id="msg"></div>
                        <div id="msg"></div>
                        </div>
