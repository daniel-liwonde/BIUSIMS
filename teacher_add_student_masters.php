    ...
    <div class="container">
        ...
        <ul class="nav  nav-pills nav-stacked">
                <li class="nav-header">Links</li>
                        <li>
                            <a href="teacher_home_masters.php"><i class="icon-home icon-large"></i>&nbsp;Home <i class="icon-double-angle-right icon-large"></i>Masters
                        ...
                        <li>
                            <a href="teacher_class_masters.php"><i class="icon-group icon-large"></i>&nbsp;Modify past results
                                <div class="pull-right">
                                    <i class="icon-double-angle-right icon-large"></i>
                                </div>
                                </a>
...
//if($q=='1x'){$query = mysqli_query($conn,"select * from student") or die(mysqli_error($conn));} else{
                                    $query = mysqli_query($conn,"select * from student where category='1'") or die(mysqli_error($conn));
//}
									 //repeat($q);
