 ...
 <tr bgcolor="#999999">
						  ...
						  $depts=mysqli_fetch_array($depart);
						   ...
						   $subtitle= $subject_details['subject_title'];						
							?>
                            <tr>
                            <td align="center"><?php echo $i ?></td><td><?php echo  $subcode;  ?></td><td><?php  echo $subtitle;if($repeated==1) echo"[<font color='red'>CarryOver</font>]" ?></td><td><?php echo $teacher_details['lastname'] ?></td><td><?php echo $depts['department']; ?>                             </td><td width="40">
