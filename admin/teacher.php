                           ...
                           <i class="icon-plus-sign icon-large"></i>&nbsp;Add Lecturer</a>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                                ...
                                <tbody>
                                    ...
                                    <td width="40"><?php if($row['location']==''){?> <img class="img-rounded" src="img/log.png" height="50" width="30" ><?php }else{ ?><img class="img-rounded" src="<?php echo $row['location']; ?>" height="50" width="30"><?php } ?></td> 
